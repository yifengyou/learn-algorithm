...
* [解题规则](docs/解题规则/解题规则.md)
    * [Python输入输出](docs/解题规则/Python输入输出.md)
    * [Python模板](docs/解题规则/Python模板.md)
    * [Python常用函数](docs/解题规则/Python常用函数.md)
* [高频算法题](docs/高频算法题/高频算法题.md)
    ...
    * [打印全排列](docs/高频算法题/打印全排列.md)
    * [判断质数](docs/高频算法题/判断质数.md)
    * [最长公共字符串的长度](docs/高频算法题/最长公共字符串的长度.md)
    * [字符串中按照字母出现字数排序](docs/高频算法题/字符串中按照字母出现字数排序.md)
    * [单次压缩编码](docs/高频算法题/单次压缩编码.md)
    * [航班预订统计](docs/高频算法题/航班预订统计.md)
    * [分糖果](docs/高频算法题/分糖果.md)
    * [多道批处理调度](docs/高频算法题/多道批处理调度.md)
    * [计算水量耗尽时间](docs/高频算法题/计算水量耗尽时间.md)
